...
public class OrderConfig {
    ...
    CommandLineRunner commandLineRunnerForOrder(OrderRepository orderRepo, OrderDetailRepository orderDetailRepo, BookedSeatRepository bookedSeatRepo) {
        return args -> {
            ...
            BookedSeat bookedSeat = new BookedSeat("BS0001", null, null, "Anh Khoa", "0123456789", 4, LocalDateTime.parse("2025-05-01T18:00:00") ,Timestamp.valueOf(LocalDateTime.now()));
